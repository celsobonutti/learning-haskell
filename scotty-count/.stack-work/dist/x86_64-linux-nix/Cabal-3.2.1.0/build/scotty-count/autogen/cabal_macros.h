...
/* package scotty-count-0.1.0.0 */
#ifndef VERSION_scotty_count
#define VERSION_scotty_count "0.1.0.0"
#endif /* VERSION_scotty_count */
#ifndef MIN_VERSION_scotty_count
#define MIN_VERSION_scotty_count(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_scotty_count */
...
#define CURRENT_COMPONENT_ID "scotty-count-0.1.0.0-KtklHgRSBdwCNF9HioIpT8-scotty-count"
